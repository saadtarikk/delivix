...
<div id="page" class="site">
    ...
    <?php if (is_front_page()) : ?>
        <section id="main-content" class="relative w-full h-full overflow-hidden hero-section" role="main">
            ...
            <header class="menu-header position-fixed w-100" id="sticky-header">
    ...
    <?php else : ?>
        <!-- Generic Page Header for non-front pages -->
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-12">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <!-- Main Menu -->
                                <nav class="menu-header--main-menu">
                                    <?php
                                    wp_nav_menu(array(
                                ...
                                <!-- Auxiliary Menu -->
                                <div class="menu-header--auxiliary-menu">
                                    <a href="#" class="nav-link btn btn-white">Contact Us</a>
                                </div>

                                <!-- Mobile Menu Toggle -->
                                <div class="menu-header--toggle d-lg-none">
                                    <button class="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#mobileMenu">
                                        <span class="menu-header--toggle-icon"></span>
                                    </button>
                                </div>
                            </div>
                        </div>
